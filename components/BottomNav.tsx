...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-1 sm:py-2 lg:py-3 w-full">
      <div className="flex gap-2 sm:gap-4 md:gap-6 lg:gap-8 h-14 sm:h-16 md:h-18 lg:h-20 items-center justify-center w-full max-w-[393px] sm:max-w-md md:max-w-lg lg:max-w-full mx-auto">
        <Link
          href="/"
